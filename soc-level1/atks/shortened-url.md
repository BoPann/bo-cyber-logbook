...
## Overview 
Many atks (especially [Phishing](../phishing-analysis/phishing.md)) like to shorten their URL to make it look less suspecious. It help hide their real domain and bypass the security check (evasion). 
