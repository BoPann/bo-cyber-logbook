...
- Cyber Kill Chain - the steps that cyber attacks commonly follow. It then be developed into [Cyber Kill Chain](framework/cyber-kill-chain.md)  which covers 18 phases. see [Official Cyber Kill Chain Doc](https://www.unifiedkillchain.com/assets/The-Unified-Kill-Chain.pdf)
	- Reconnaissance
	- Weaponisation
	- Delivery
	- Exploitation
